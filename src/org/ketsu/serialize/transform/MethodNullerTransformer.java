...
public class MethodNullerTransformer implements ClassFileTransformer
{
	protected final Map<String, Collection<String>> toRemove = new HashMap<>();

	public MethodNullerTransformer(String args)
	{
		if(args != null)
		{
	...
	{
		instrumentation.addTransformer(new MethodNullerTransformer(args));
	}
}
